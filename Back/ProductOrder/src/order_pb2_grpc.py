...
class OrderServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateOrder = channel.unary_unary(
                ...
                request_serializer=order__pb2.ProductOrder.SerializeToString,
...
def add_OrderServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'CreateOrder': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=order__pb2.ProductOrder.FromString,
...
class OrderService(object):
    ...
    def CreateOrder(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/OrderService/CreateOrder',
            order__pb2.ProductOrder.SerializeToString,
